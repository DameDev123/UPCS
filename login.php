...
if (isset($_POST['login'])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        if (password_verify($pass, $user['password'])) {
            ...
            } elseif ($user['role'] == 'hod' || $user['role'] == 'admin') {
                header("Location: admin.php");
            }
            exit();
        } else {
            $msg = "<div class='alert error'>Incorrect password!</div>";
        }
    } else {
...
<head>
    ...
    <title>Login - AUHHC Project System</title>
        ...
        <div>
            ...
            <div class="card">
                ...
                <p style="text-align: center; margin-top: 1rem; color: #64748b;">
                    Don't have an account? <a href="signup.php" style="color: var(--primary);">Register here</a>
                </p>
